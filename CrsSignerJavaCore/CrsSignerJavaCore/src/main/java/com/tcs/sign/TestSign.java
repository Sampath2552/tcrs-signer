...
//            System.exit(1);
    ...
    public static boolean configureSignature(String pass,String src,String role) throws KeyStoreException, CertificateException, IOException, NoSuchAlgorithmException, UnrecoverableKeyException, OperatorCreationException, CMSException {
        boolean state = false;
        System.out.println("Inside configure Signature Function");
//        String src="F:\\PDFSigner\\SIgnTEst.pdf";
...
// Security.addProvider(providerPKCS11);
//        Provider providerPKCS11 = Security.getProvider("PKCS11");
...
//        List<BookMark> bookmarks = ExtractBookmarks.extractB(srcFile);
        ...
        System.out.println(currentBookmark);
        float rectWidth = 130;
        float rectHeight = 50;
...
//        System.out.println("sign 11111111111111" + pk);
        // sign 11111111111111SunPKCS11-mToken RSA private key, 2048 bits (id 4030438400, token object, sensitive, unextractable)
        // sign 11111111111111SunPKCS11-mToken RSA private key, 2048 bits (id 1569303392, token object, sensitive, unextractable)
//        System.out.println("sign 11111111111111");

        ContentSigner contentSigner = new JcaContentSignerBuilder("SHA256withRSA").build(pk);
//        System.out.println("sign 22222222222");
...
//        CMSProcessableByteArray msg = new CMSProcessableByteArray(content);
        ...
        System.out.println("Before gen generate");
        CMSSignedData signedData = gen.generate(msg,false);
        System.out.println("After gen generate");
...
//                cs.newLine();
    ...
    public static Map<String,Object> configureSignatureForByteArray(String pass, byte[] barr, String role,String alias) throws KeyStoreException, CertificateException, IOException, NoSuchAlgorithmException, UnrecoverableKeyException, OperatorCreationException, CMSException {
        boolean state = false;
       ...
       // String alias= aliases.nextElement();
        ...
        System.out.println("Before Getting Private Key");
        PrivateKey pk = (PrivateKey) keyStore.getKey(alias, "Password123".toCharArray());
...
//        ByteArrayInputStream bais = new ByteArrayInputStream(barr);
        ...
        PDVisibleSigProperties signatureProperties = new PDVisibleSigProperties();
        signatureProperties.signerName(cnName).signerLocation(location)
                .signatureReason(reason).preferredSize(0).page(1)
                .visualSignEnabled(true);
        ...
        try{
            ...
            System.out.println("Before csmSignature:");
            byte[] csmSignature = sign(externalSigningSupport.getContent(),cl,pk,cert);
            externalSigningSupport.setSignature(csmSignature);
            System.out.println("After csmSignature:");
        }
        catch(Exception e)
        {
            System.out.println(e.getMessage());
    ...
    public static void main(String[] args) throws UnrecoverableKeyException, CertificateException, KeyStoreException, IOException, NoSuchAlgorithmException, OperatorCreationException, CMSException, InterruptedException {
        System.out.println("in TestSign File");
        ...
        {   System.out.println("Count ="+i);
            TestSign.configureSignatureForByteArray("Password123", barr, "checker","ANIL BABU KAYALORATH");
            Thread.sleep(10000);
        }

       // TestSign.configureSignatureForByteArray("Password123", barr, "checker","ANIL BABU KAYALORATH");
       // System.out.println(signedMap1);

       // byte[] barr2 = (byte[]) signedMap.get("signedContent");
      //  System.out.println(Base64.getEncoder().encodeToString(barr2));
    }
}
