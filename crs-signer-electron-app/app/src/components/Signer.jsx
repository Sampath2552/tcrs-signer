...
const Signer = ({isApplicationConnected,isCertificateConfigured,crsLoggedInUserId,certificateHolder})=>{
    ...
    return (
        <>
            ...
            <Alert severity="warning" sx={{marginBottom:"10px"}}>Avoid detaching the DSC token or closing the browser until signing is completed.</Alert>
            ...
            <Box >
                <Grid container spacing={2}>
                    ...
                    <Grid size={4}>
                        <Card >
                            ...
                            <Paper sx={{padding:"16px"}} elevation={5}> <CardMedia sx={{display:"flex",gap:"20px"}}>
                ...
                <Alert sx={{marginTop:1}} severity="info">Go to application to initiate Sign the required file/s .</Alert>
